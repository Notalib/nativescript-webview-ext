...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="NotaWebViewExt",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC14NotaWebViewExt19CustomNSURLProtocol")
@interface CustomNSURLProtocol : NSURLProtocol <NSURLConnectionDelegate, NSURLSessionTaskDelegate>
...
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, copy) NSDictionary<NSString *, NSString *> * _Nonnull resourceDict;)
+ (NSDictionary<NSString *, NSString *> * _Nonnull)resourceDict SWIFT_WARN_UNUSED_RESULT;
+ (void)setResourceDict:(NSDictionary<NSString *, NSString *> * _Nonnull)value;
