...
xcodebuild -project ./native-src/ios/NotaWebViewExt/NotaWebViewExt.xcodeproj -target NotaWebViewExt -sdk iphoneos -configuration Release ARCHS="armv7 arm64"
xcodebuild -project ./native-src/ios/NotaWebViewExt/NotaWebViewExt.xcodeproj -target NotaWebViewExt -sdk iphonesimulator -configuration Release ARCHS="i386 x86_64"

XCODE_BUILD_PATH="./native-src/ios/NotaWebViewExt/build"
